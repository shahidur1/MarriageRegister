...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="news.html">Yearly Record</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="about.html">Monthly Record</a>
              </li>
    ...
    <div class="container">
          <div class="row">
            ...
            <input type="submit" class="btn btn-toolbar" value="Awaiting Kazi List"></input>
            </form>
            </div>
            <div class="col-4">
              <form action="kaShow.htm">
            <input type="submit" class="btn btn-toolbar" value="Approved Kazi List"></input>
            </form>
            </div>
            <div class="col-4">
              <form action="revenueShow.htm">
            <input type="submit" class="btn btn-toolbar" value="Revenue Chart"></input>
            </form>
            </div>
    ...
    <center>
        <hr/>
        <h2 class="heading h2"><u>Applied Kazi List Who are not approved Yet</u></h2>
  ...
  <center>
        <hr/>
        <h2 class="heading h2"><u>Approved Kazi List</u></h2>
  ...
  <center>
        <hr/>
        <h2 class="heading h2"><u>Revenue Chart</u></h2>
        <table class="table-striped table-hover" border="2" cellspacing="0" cellpadding="5">
            <tr class="table-head table-row">
                
               
                <td>Kazi ID</td>
                <td>Kazi Full Address</td>
