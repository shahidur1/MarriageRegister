...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="payslip.jsp">Payment Slip</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container">
          <div class="row">
            <div class="col-4">
             <form action="statuscheck.htm">
                <input type="text" placeholder="Write Bride NID" name="bnid"></input>
                <input type="text" placeholder="Write Bride Date of Birth" name="bdop"></input>
                <input type="submit" class="btn btn-toolbar" value="Check Status"></input>
            </form>
            </div>
            <div class="col-4">
    ...
    <center>
        <hr/>
        <h2 class="heading h2"><u>Here is Your Status</u></h2>
