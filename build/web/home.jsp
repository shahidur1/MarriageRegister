...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-6 text-right d-sm-flex d-flex">
              <d class="ml-auto">
                  <a href="appointmentt.jsp" class="btn">Appointment</a>
                  
                  <a href="portal.jsp" class="cta-btn">Portal</a>
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="services.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Register Service</a>
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="adoption.html">Marriage</a>
                  <a class="dropdown-item" href="adoption.html">Divorce</a>
                  <a class="dropdown-item" href="adoption.html">Marriage Media</a>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item dark" style="background-image: url('MRegister/img/slider1.jpg');">
        
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-6 col-sm-12 element-animate">
              <span class="child-name cursive">Abdullah & Fatimah</span>
              <h1>Newly Coupled by Muslim Marriage Register </h1>
              <p><a href="#" class="btn btn-primary">Book Appointment Now!</a></p>
            </div>
          </div>
        </div>
      ...
      <div class="slider-item" style="background-image: url('MRegister/img/slider2.jpg');">
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-6 col-sm-12 element-animate">
                <span class="child-name cursive">Rafiya &AMP; Talha Jubayer</span>
              <h1>Needs a Loving Partner</h1>
              <p>Tell your parents to find a partner and fix the date and book us for registration.</p>
              <p><a href="#" class="btn btn-primary">Book Appointment Now!</a></p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 mb-4">
              <img src="MRegister/img/MarriageRegistration.jpg" width="90%" alt="Marriage"/>

<p class="mb-5">Muslim Marriage Registration is a valid process to get Married, Now You can easily complete your Marriage Registration and getting Nikahnama with this system.</p>
<p><a href="#" class="btn btn-outline-primary">Book Appointment Now!</a></p>

          </div>
          <div class="col-md-1"></div>
          <div class="col-md-6">
            <h2 class="mb-5">Steps to getting Marriage Registration</h2>
            <div id="accordion">
              <div class="card mb-2">
                <h5 class="mb-0">
                  <a href="#" class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    1. Fill form Online for Appointment
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                  <div class="card-body">
                      <img src="MRegister/img/1 Information.png" alt=""/>
                      By Providing some core information related both the partner and fix date and place you can Book an Appointment.
                  </div>
                </div>
              </div>
              <div class="card mb-2">
                <h5 class="mb-0">
                  <a href="#" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    2. Paid the Marriage Registration Fee
                    <span class="icon ion-chevron-down"></span>
                  </a>
                </h5>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                  <div class="card-body">
                      <img src="MRegister/img/2 Payment.png" alt=""/>
                      After verifying your age and contact, Marriage Register will send an Appointment Confirmation. Now pay the Registration fee by Bank or Suggested Chanel.
                  </div>
                </div>
              </div>
              <div class="card mb-2">
                <h5 class="mb-0">
                  <a href="#" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    3. Marriage Registration Completion by Register
                    <span class="icon ion-chevron-down"></span>
                  </a>
                </h5>
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                  <div class="card-body">
                      <img src="MRegister/img/3 FormFill.png" alt=""/>                    
                      After your payment. Marriage Register will attend in the register place and complete your marriage registration.
                  </div>
                </div>
              </div>
              <div class="card mb-2">
                <h5 class="mb-0">
                  <a href="#" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    4. Getting all the Registration Paper
                    <span class="icon ion-chevron-down"></span>
                  </a>
                </h5>
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                  <div class="card-body">
                      <img src="MRegister/img/4 Certificate.png" alt=""/>
                      After 7 days of registration you will get all the papers related to this will be provided by Marriage Register without any fees.
                  </div>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 element-animate">
          <div class="col-md-8 text-center">
            ...
            <p class="mb-0"><a href="#" class="btn btn-primary">Find More Waiting Person <span class="icon-arrow"></span></a></p>
          </div>
        </div>
