...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
          <div class="row">
            <div class="col-4">
             <form action="kfbook.htm">
                 <input type="text" placeholder="Write your District" name="district"></input>
                <input type="text" placeholder="Write your Union" name="unionn"></input>
                <input type="submit" class="btn btn-toolbar" value="Search Kazi"></input>
            </form>
            </div>
            <div class="col-4">
    ...
    <center>
        <hr/>
        <h2 class="heading h2"><u>Available Kazi for Your Locality</u></h2>
        <table class="table-striped table-hover" border="2" cellspacing="0" cellpadding="5">
            ...
            <c:forEach var="c" items="${kaalist}">
                ...
                <tr>
                    ...
                    <td>${c.contact}</td>
                    <td>${c.email}</td>
                   <td><a href="rdAppoint.htm?kaziid=${c.kaziid}&districtid=${c.districtid}&kname=${c.kname}">Book Appointment</a></td>
                </tr>
