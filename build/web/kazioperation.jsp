  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="adlogin.jsp">Log Out</a>
              </li>
            </ul>
    ...
    <div class="container">
          <div class="row">
            ...
            <input type="submit" class="btn btn-toolbar" value="Appointment Request"></input>
            </form>
            </div>
            <div class="col-4">
              <form action="nrShow.htm">
            <input type="submit" class="btn btn-toolbar" value="Payable Fees"></input>
            </form>
            </div>
            <div class="col-4">
              <form action="kazipanel_1.jsp">
            <input type="submit" class="btn btn-toolbar" value="Registration"></input>
            </form>
            </div>
    ...
    <center>
        ...
        <table class="table-striped table-hover" border="2" cellspacing="0" cellpadding="5">
            ...
            <c:forEach var="a" items="${list}">
                ...
                <tr>
                    ...
                    <td>${a.kname}</td>
                    <td>${a.districtid}</td>
                    <td><a href="rdpayper.htm?appointmentid=${a.appointmentid}
                           &bnid=${a.bnid}&bdop=${a.bdop}&mohor=${a.mohor}">Grant Request</a></td>
                           
                    <td><a href="rdnrfee.htm?appointmentid=${a.appointmentid}
                           &bgname=${a.bgname}&mohor=${a.mohor}&kaziid=${a.kaziid}&districtid=${a.districtid}&kname=${a.kname}">Update Pay slip</a></td>
                </tr>
     ...
     <div class="row">
        <div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60">
							<form class="form-wrap" action="apUpdated.htm">
								<h3 class="pb-20 text-center mb-30">Issue Payment Order</h3>		
                                                                <input type="text" class="form-control" name="appointmentid" value="${appointment.appointmentid}" placeholder="Appointment ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Appointment ID'" >
                                                                <input type="text" class="form-control" name="bnid" value="${appointment.bnid}" placeholder="Bride NID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Bride NID'" >
                                                                <input type="text" class="form-control" name="bdop" value="${appointment.bdop}" placeholder="Bride's Birth" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Bride Birth'" >
                                                                <input type="text" class="form-control" name="mohor" value="${appointment.mohor}" placeholder="Mohor" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Mohor'" >
								<input type="text" class="form-control" name="status" placeholder="Pay Permission Order" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Pay Permission order'" >
								<input type="text" class="form-control" name="kazimessage" placeholder="Instruction for payment" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Instruction for payment'" >
		
                                                                <input type="submit" class="primary-btn text-uppercase" value="Approve Payment"></input>
							</form>
</div>
         <div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60">
							<form class="form-wrap" action="nrfeeSave.htm">
								<h3 class="pb-20 text-center mb-30">Payment Slip Generator</h3>		
                                                                <input type="text" class="form-control" name="appointmentid" value="${appointment.appointmentid}" placeholder="Appointment ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Appointment ID'" >
                                                                <input type="text" class="form-control" name="bgname" value="${appointment.bgname}" placeholder="Bride Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Bride Name'" >
                                                                <input type="text" class="form-control" name="mohor" value="${appointment.mohor}" placeholder="Mohor" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Mohor'" >
								<input type="text" class="form-control" name="date" placeholder="Date of Bill" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Date of Bill'" >
								<input type="text" class="form-control" name="kaziid" value="${appointment.kaziid}" placeholder="Kazi ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Kazi ID'" >
								<input type="text" class="form-control" name="districtid" value="${appointment.districtid}" placeholder="District ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'District ID'" >
								<input type="text" class="form-control" name="district" placeholder="District" onfocus="this.placeholder = ''" onblur="this.placeholder = 'District'" >
								<input type="text" class="form-control" name="fulladdress" placeholder="Full Address of Kazi" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Full Address of Kazi'" >
								<input type="text" class="form-control" name="kname" value="${appointment.kname}" placeholder="Kazi Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Kazi Name'" >
		
                                                                <input type="submit" class="primary-btn text-uppercase" value="Save Pay Slip"></input>
							</form>
</div>
